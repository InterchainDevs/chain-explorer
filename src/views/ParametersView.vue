<template> 
    ...
    <v-sheet border rounded="lg" class="pa-2 mb-4 animate__animated animate__backInRight">        
            ...
            <tr>
              ...
              <td class="text-right">
                <v-chip
                  ...
                  label
                >
                {{ Number(store?.mintParams[0]?.annualProvisions).toFixed(2) }} BCNA
                </v-chip>  
                </td>
            </tr>
          </tbody>
    ...
    <v-sheet border rounded="lg" class="pa-2 mb-4 animate__animated animate__backInLeft">        
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <v-chip
                          ...
                          label
                        >
                        {{ store?.govParams.tallying?.tally_params.veto_threshold * 100 }} %
                        </v-chip>
                      </td>
                    </tr>
                  </tbody>
            ...
            <tr>
              ...
              <td>
                <v-chip
                  ...
                  label
                >
                {{ store?.govParams.deposit?.deposit_params.min_deposit[0].amount / 1000000 }} BCNA
                </v-chip>                
              </td>
            </tr>
            <tr>
